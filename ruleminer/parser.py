...
COLUMNS_S = ARITH_COLUMNS | (PARL + ARITH_COLUMNS + PARR) | COLUMN | NUMBER
...
ARITH_COLUMNS_NESTED_3 =  Group(COLUMNS_S  + (ARITH_OP + PARL + ARITH_COLUMNS_NESTED_2 + PARR)[0,...] + (ARITH_OP+ ARITH_COLUMNS_NESTED_2)[0,1])
